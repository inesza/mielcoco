 ...
 */
final class Version20200311104241 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE niveau niveau VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE niveau niveau INT NOT NULL');
    }
}
